...
import Label from "../../Label"; // plasmic-import: FDVhqvUTQn3S/component
import TextInput from "../../TextInput"; // plasmic-import: MArGxXIcQ7-_/component
import TextAreaInput from "../../TextAreaInput"; // plasmic-import: mEscwhtjrK2x/component
import Description from "../../Description"; // plasmic-import: MNKUITDjajR4/component
...
import sty from "./PlasmicTextField.module.css"; // plasmic-import: j-F7rqXkCu17/css
...
function PlasmicTextField__RenderFunc(props: {
  ...
  return (
    ...
    >
      ...
      <div
        className={classNames(projectcss.all, sty.freeBox__nkeRu, {
          [sty.freeBoxiconEnd__nkeRu3KRsL]: hasVariant(
            $state,
            "iconEnd",
            "iconEnd"
          ),
          [sty.freeBoxiconStart__nkeRuHbg0]: hasVariant(
            $state,
            "iconStart",
            "iconStart"
          ),
          [sty.freeBoxmultiLine__nkeRuQXH]: hasVariant(
            $state,
            "multiLine",
            "multiLine"
          )
      ...
      >
        <div
          className={classNames(projectcss.all, sty.freeBox__rEIuR, {
            [sty.freeBoxiconStart__rEIuRHbg0]: hasVariant(
              $state,
              "iconStart",
              "iconStart"
            ),
            [sty.freeBoxmultiLine__rEIuRQXH]: hasVariant(
              $state,
              "multiLine",
              "multiLine"
            )
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <CircleIcon
                className={classNames(projectcss.all, sty.svg__d9Dzu)}
                role={"img"}
              />
            ),
        ...
        <div
          className={classNames(projectcss.all, sty.freeBox__m8Ee7, {
            [sty.freeBoxiconEnd__m8Ee73KRsL]: hasVariant(
              $state,
              "iconEnd",
              "iconEnd"
            ),
            [sty.freeBoxiconStart__m8Ee7Hbg0]: hasVariant(
              $state,
              "iconStart",
              "iconStart"
            )
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <CircleIcon
                className={classNames(projectcss.all, sty.svg__cgiPf)}
                role={"img"}
              />
            ),
