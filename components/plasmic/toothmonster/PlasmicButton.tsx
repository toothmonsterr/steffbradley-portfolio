  ...
  return (
    <BaseButton
      ...
      className={classNames(
        ...
        sty.root,
        {
          ...
          [sty.rootcolor_peach_type_soft]:
            hasVariant($state, "type", "soft") &&
            hasVariant($state, "color", "peach"),
          ...
          [sty.roottype_bordered_color_neutral]:
            hasVariant($state, "color", "neutral") &&
            hasVariant($state, "type", "bordered"),
          [sty.roottype_bordered_color_peach]:
            hasVariant($state, "color", "peach") &&
            hasVariant($state, "type", "bordered"),
    ...
    >
      <div
        ...
        className={classNames("all", sty.hover, {
          [sty.hovercolor_blue_type_soft]:
            hasVariant($state, "color", "blue") &&
            hasVariant($state, "type", "soft"),
          [sty.hovercolor_peach_type_soft]:
            hasVariant($state, "type", "soft") &&
            hasVariant($state, "color", "peach"),
      ...
      <div
        className={classNames("all", sty.freeBox___1It5P, {
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <div className={classNames("all", sty.freeBox__fPc5S)} />
          ),
      ...
      {(
        ...
        <div
          ...
          className={classNames("all", sty.softBackground, {
            ...
            [sty.softBackgroundcolor_blue_type_soft]:
              hasVariant($state, "color", "blue") &&
              hasVariant($state, "type", "soft"),
            ...
            [sty.softBackgroundcolor_neutral_type_soft]:
              hasVariant($state, "color", "neutral") &&
              hasVariant($state, "type", "soft"),
            [sty.softBackgroundcolor_peach_type_soft]:
              hasVariant($state, "type", "soft") &&
              hasVariant($state, "color", "peach"),
      ...
      {(hasVariant($state, "type", "bordered") ? true : false) ? (
        <div
          ...
          className={classNames("all", sty.border, {
            ...
            [sty.bordercolor_peach_type_soft]:
              hasVariant($state, "type", "soft") &&
              hasVariant($state, "color", "peach"),
            ...
            [sty.bordertype_bordered_color_neutral]:
              hasVariant($state, "color", "neutral") &&
              hasVariant($state, "type", "bordered"),
            [sty.bordertype_bordered_color_peach]:
              hasVariant($state, "color", "peach") &&
              hasVariant($state, "type", "bordered"),
      ...
      <div
        className={classNames("all", sty.freeBox__lahjq, {
      ...
      >
        <div
          className={classNames("all", sty.freeBox___9KkaF, {
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <CircleIcon
                className={classNames("all", sty.svg__otinb)}
                role={"img"}
              />
            ),
        ...
        {renderPlasmicSlot({
          defaultContents: (
            <div className={classNames("all", "__wab_text", sty.text__pndxP)}>
              {"Text"}
            </div>
          ),
          value: args.label,
          className: classNames(sty.slotTargetLabel, {
            ...
            [sty.slotTargetLabelcolor_blue_type_soft]:
              hasVariant($state, "color", "blue") &&
              hasVariant($state, "type", "soft"),
            ...
            [sty.slotTargetLabeltype_bordered_color_neutral]:
              hasVariant($state, "color", "neutral") &&
              hasVariant($state, "type", "bordered"),
            [sty.slotTargetLabeltype_bordered_color_peach]:
              hasVariant($state, "color", "peach") &&
              hasVariant($state, "type", "bordered"),
        ...
        <div
          className={classNames("all", sty.freeBox__oEbX6, {
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <ChevronDownIcon
                className={classNames("all", sty.svg___08QHn)}
                role={"img"}
              />
            ),
