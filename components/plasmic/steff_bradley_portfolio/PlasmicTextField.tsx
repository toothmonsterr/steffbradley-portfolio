...
import Description from "../../Description"; // plasmic-import: Agn9IVinmI6Q/component
...
import sty from "./PlasmicTextField.module.css"; // plasmic-import: NxVY0qVMg82Q/css
...
function PlasmicTextField__RenderFunc(props: {
  ...
  return (
    ...
    >
      ...
      <div
        className={classNames("all", sty.freeBox__wgs2E, {
          [sty.freeBoxiconEnd__wgs2EohmrW]: hasVariant(
            $state,
            "iconEnd",
            "iconEnd"
          ),
          [sty.freeBoxiconStart__wgs2EKfLs]: hasVariant(
            $state,
            "iconStart",
            "iconStart"
          ),
          [sty.freeBoxmultiLine__wgs2EcUh41]: hasVariant(
            $state,
            "multiLine",
            "multiLine"
          )
      ...
      >
        <div
          className={classNames("all", sty.freeBox__cy8Ig, {
            [sty.freeBoxiconStart__cy8IgKfLs]: hasVariant(
              $state,
              "iconStart",
              "iconStart"
            ),
            [sty.freeBoxmultiLine__cy8IgCUh41]: hasVariant(
              $state,
              "multiLine",
              "multiLine"
            )
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <CircleIcon
                className={classNames("all", sty.svg__y4CDg)}
                role={"img"}
              />
            ),
        ...
        <div
          className={classNames("all", sty.freeBox___2FvLt, {
            [sty.freeBoxiconEnd___2FvLtohmrW]: hasVariant(
              $state,
              "iconEnd",
              "iconEnd"
            ),
            [sty.freeBoxiconStart___2FvLtKfLs]: hasVariant(
              $state,
              "iconStart",
              "iconStart"
            )
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <CircleIcon
                className={classNames("all", sty.svg__dJXik)}
                role={"img"}
              />
            ),
